...
@Component({
    ...
    standalone   : true,
    imports      : [OmanOnlineLoadingBarComponent, NgIf, OmanOnlineVerticalNavigationComponent, OmanOnlineHorizontalNavigationComponent, MatButtonModule, MatIconModule, OmanOnlineFullscreenComponent, RouterOutlet,SettingsComponent],
})
