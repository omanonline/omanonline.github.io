...
import { FSDocument, FSDocumentElement } from '@omanonline/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'omanonline-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'omanonlineFullscreen',
    standalone     : true,
    imports        : [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class OmanOnlineFullscreenComponent implements OnInit
{
