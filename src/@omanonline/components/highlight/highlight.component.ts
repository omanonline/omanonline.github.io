...
import { OmanOnlineHighlightService } from '@omanonline/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[omanonline-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'omanonlineHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class OmanOnlineHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _omanonlineHighlightService: OmanOnlineHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._omanonlineHighlightService.highlight(this.code, this.lang));
