...
@Component({
    selector       : 'omanonline-vertical-navigation-aside-item',
    templateUrl    : './aside.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, OmanOnlineVerticalNavigationBasicItemComponent, OmanOnlineVerticalNavigationCollapsableItemComponent, OmanOnlineVerticalNavigationDividerItemComponent, OmanOnlineVerticalNavigationGroupItemComponent, OmanOnlineVerticalNavigationSpacerItemComponent],
})
export class OmanOnlineVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy
{
