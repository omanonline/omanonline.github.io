...
@Component({
    selector       : 'omanonline-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : omanonlineAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, OmanOnlineVerticalNavigationBasicItemComponent, forwardRef(() => OmanOnlineVerticalNavigationCollapsableItemComponent), OmanOnlineVerticalNavigationDividerItemComponent, OmanOnlineVerticalNavigationGroupItemComponent, OmanOnlineVerticalNavigationSpacerItemComponent],
})
export class OmanOnlineVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'omanonline-vertical-navigation-item-collapsed': this.isCollapsed,
            'omanonline-vertical-navigation-item-expanded' : this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._omanonlineVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._omanonlineVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._omanonlineVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._omanonlineVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: OmanOnlineNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: OmanOnlineNavigationItem, item: OmanOnlineNavigationItem): boolean
    {
