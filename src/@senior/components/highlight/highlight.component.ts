...
import { SeniorHighlightService } from '@senior/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[senior-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'seniorHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class SeniorHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _seniorHighlightService: SeniorHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._seniorHighlightService.highlight(this.code, this.lang));
