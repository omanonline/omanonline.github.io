...
import { FSDocument, FSDocumentElement } from '@senior/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'senior-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'seniorFullscreen',
    standalone     : true,
    imports        : [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class SeniorFullscreenComponent implements OnInit
{
