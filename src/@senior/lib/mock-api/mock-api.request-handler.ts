...
import { SeniorMockApiReplyCallback } from '@senior/lib/mock-api/mock-api.types';

export class SeniorMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: SeniorMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: SeniorMockApiReplyCallback): void
    {
        // Store the reply
