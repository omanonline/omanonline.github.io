...
import { ScrollbarGeometry, ScrollbarPosition } from '@senior/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[seniorScrollbar]',
    exportAs  : 'seniorScrollbar',
    standalone: true,
})
export class SeniorScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_seniorScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() seniorScrollbar: boolean = true;
    @Input() seniorScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'seniorScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.seniorScrollbar = coerceBooleanProperty(changes.seniorScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.seniorScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'seniorScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.seniorScrollbarOptions.currentValue);
